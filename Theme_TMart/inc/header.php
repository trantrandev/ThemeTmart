...
<head>
	...
	<!-- jquery evolator zoom -->
	<script type="text/javascript" src="public/js/elevatezoom-master/jquery.elevateZoom-3.0.8.min.js"></script>
...
<body>
	<div id="wrapper">
		<div id="header">
					...
					<ul class="list-info d-flex justify-content-between">
						...
						<li class="account">
							...
							<div class="account-content content">
								...
								<span>Xin chào</span>
								<ul class="login">
									<li class="login"><a href="?page=login">Đăng nhập</a></li>
									<li class="register"><a href="?page=register">Đăng ký</a></li>
								</ul>
							</div>
						</li>
						<li class="cart">
			...
			<?php require 'main_navigation_hide.php'; ?>
		</div>
		<!-- End header -->